...
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="languages.htm#how" class="en">Hoe talen werken in Coppermine</a>\n';
doc_toc += '            <ul>\n';
...
doc_toc += '          </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="upgrading.htm#versioncheck" class="en">Versiecontrole</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '    </ul>\n';
doc_toc += '  </li>\n';
doc_toc += '  <li><a href="theme.htm" class="us_nl">Thema\'s</a>\n';
doc_toc += '    <ul>\n';
doc_toc += '      <li><a href="theme.htm#theme_builtin" class="nl">Thema\'s die meekomen met Coppermine</a></li>\n';
doc_toc += '      <li><a href="theme.htm#theme_upgrading" class="nl">Upgrade van uw aangepast thema</a>\n';
doc_toc += '      <ul>\n';
...
doc_toc += '      </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="theme.htm#theme_files" class="nl">Thema-inhoud</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="theme_style_css.htm#theme_style_css_tools" class="en">Instrumenten</a>\n';
doc_toc += '                <ul>\n';
doc_toc += '                  <li><a href="theme_style_css.htm#theme_style_css_tools_webdev" class="en">Gebruik van Web Developer toolbar</a></li>\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="theme.htm#theme_engine" class="nl">Hoe het themasysteem werkt</a></li>\n';
doc_toc += '      <li><a href="theme_user-contributions.htm#theme_user-contributions" class="en">Gebruiker-ontworpen thema\'s</a>\n';
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="theme_user-contributions.htm#theme_user-contributions_preview" class="en">Bekijk gebruiker-ontworpen thema\'s</a></li>\n';
doc_toc += '          <li><a href="theme_user-contributions.htm#theme_user-contributions_download" class="en">Download gebruiker-ontworpen thema\'s</a></li>\n';
doc_toc += '          <li><a href="theme_user-contributions.htm#theme_user-contributions_install" class="en">Installeer gebruiker-ontworpen thema\'s</a></li>\n';
doc_toc += '          <li><a href="theme_user-contributions.htm#theme_user-contributions_copyrights" class="en">Copyrights van gebruiker-ontworpen thema\'s</a></li>\n';
doc_toc += '          <li><a href="theme_user-contributions.htm#theme_user-contributions_support" class="en">Vraag naar support voor  gebruiker-ontworpen thema\'s</a></li>\n';
doc_toc += '          <li><a href="theme_user-contributions.htm#theme_user-contributions_contributing" class="en">Ontwerp uw eigen thema</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="theme_create.htm#theme_create" class="nl">Creating your custom theme</a>\n';
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="theme_create.htm#theme_create_rename" class="nl">Rename your theme first</a></li>\n';
doc_toc += '          <li><a href="theme_create.htm#theme_create_tipps" class="nl">Tips &amp; tricks</a></li>\n';
doc_toc += '          <li><a href="theme_create.htm#theme_create_wysiwyg" class="nl">Gebruik van WYSIWYG-editors</a></li>\n';
doc_toc += '          <li><a href="theme_create.htm#theme_create_colors" class="nl">Aanpassen van kleuren</a></li>\n';
doc_toc += '          <li><a href="theme_create_matching_page_tutorial.htm#theme_matching" class="en">Ontwerpen van een  Coppermine thema dat past bij de layout van uw website</a>\n';
doc_toc += '            <ul>\n';
...
doc_toc += '    </ul>\n';
doc_toc += '  </li>\n';
doc_toc += '  <li><a href="administration.htm" class="us_nl">Beheer</a>\n';
doc_toc += '    <ul>\n';
doc_toc += '      <li><a href="admin_menu.htm" class="nl">Admin menu-items</a>\n';
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="admin_menu.htm#admin_user_mode" class="nl">In-/ uitschakelen van beheerdersfunctie</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#upload_approval" class="nl">Upload goedkeuring</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#config" class="nl">Configuratie</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#categories" class="nl">Categorieën</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#albums" class="nl">Albums</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#sort_my_pictures" class="nl">Sorteer mijn foto\'s</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#groups" class="nl">Groepen</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#users" class="nl">Gebruikers</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#ban" class="nl">Ban Gebruikers</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#my_profile" class="nl">Mijn profiel</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#review_comments" class="nl">Bespreek Commentaren</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#ecard_log" class="nl">Toon E-kaarten</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#batch_add" class="nl">Bestanden toevoegen in Batch</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#admin_tools" class="nl">Admin Instrumenten (Herschalen Foto\'s)</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#keyword_manager" class="nl">Trefwoord manager</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#plugin_manager" class="nl">Plugin Manager</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#bridge_manager" class="nl">Bridge Manager</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#view_log" class="nl">Bekijk logbestanden</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#stats" class="nl">Algemene statistiek</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#versioncheck" class="nl">Controleer versies</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#update_database" class="nl">Update database</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#export" class="nl">Export</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#phpinfo" class="nl">PHP-info</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#show_news" class="nl">Toon nieuws</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#documentation" class="nl">Documentatie</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#admin_mode_regular_users" class="nl">Admin modus voor gewone gebruikers</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#user_menu_items" class="nl">Admin menu-items voor gewone gebruikers</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="admin-tools.htm#admin_tools" class="nl">Beheerdersinstrumenten</a>\n';
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="admin-tools.htm#admin_tools_options" class="nl">Beschikbare opties</a>\n';
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="admin-tools.htm#admin_tools_options_rebuild" class="nl">Update thumbs en/of verkleinde foto\'s</a></li>\n';
...
doc_toc += '              <li><a href="admin-tools.htm#admin_tools_options_intermediate" class="nl">Wis middelgrote foto\'s </a></li>\n';
...
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="dev_update.htm#dev_update_target_audience" class="nl">Doelpubliek</a></li>\n';
doc_toc += '          <li><a href="dev_update.htm#dev_update_hidden_feature" class="nl">Verborgen functie</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
