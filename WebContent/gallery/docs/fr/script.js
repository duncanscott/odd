...
doc_toc += '      <li><a href="start.htm#getting_typical">Réglages particuliers</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '    <ul>\n';
doc_toc += '      <li><a href="theme.htm#theme_builtin">Thèmes livrés avec Coppermine</a></li>\n';
...
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '          <li><a href="dev_coding.htm#dev_coding_database">Requêtes de base de donnée</a></li>\n';
