...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="auto-installers.htm" class="en">Auto-Instaladores</a></li>\n';
...
doc_toc += '    <ul>\n';
doc_toc += '      <li><a href="theme.htm#theme_builtin" class="en">Temas incluidos en Coppermine</a></li>\n';
...
function cpgDocHeader() {
	...
	$('#docheader').text('Coppermine Photo Gallery v1.5.6: Documentación');
