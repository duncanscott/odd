...
$lang_translation_info['trans_date'] = '2010-02-04';
...
$lang_main_menu['adm_mode_title'] = 'Переключиться в режим администратора';

$lang_main_menu['adm_mode_lnk'] = 'Режим администратора';

$lang_main_menu['usr_mode_title'] = 'Переключиться в режим пользователя';

$lang_main_menu['usr_mode_lnk'] = 'Режим пользователя';
...
$lang_gallery_admin_menu['documentation_title'] = 'Руководство по Coppermine';

$lang_gallery_admin_menu['phpinfo_lnk'] = 'Отобразить phpinfo'; // cpg1.5
...
$lang_img_nav_bar['pic_pos'] = 'ФАЙЛОВ %s/%s';
...
$lang_img_nav_bar['go_back_x_items'] = 'перейти назад на %s файлов';

$lang_img_nav_bar['go_forward_x_items'] = 'перейти вперед на %s файлов';
...
$lang_rate_pic['rating'] = '(текущий рейтинг: %s / 5 - Голосов: %s)';
...
$lang_albmgr_php['cancel'] = 'Отменить'; // cpg1.5
...
$lang_banning_php['error_server_ban'] = 'Вы собираетесь заблокировать свой личный сервер? Не могу сделать этого...';
...
$lang_banning_php['delete_comments'] = 'Удалить комментарии пользователя'; // cpg1.5
...
$lang_banning_php['comments_deleted'] = '%s комментарев, оставленных %s, были удалены'; // cpg1.5
...
$lang_bridgemgr_php['error_no_trailing_slash'] = 'Недолжно быть слеша в поле %s.';

$lang_bridgemgr_php['error_trailing_slash'] = 'Должен быть слеш в поле %s.';
...
$lang_admin_php['reduce_watermark'] = 'Уменьшить водяной знак, если ширина изображения меньше, чем введенное значение. Это 100% указанная точка. Изменение размера водяного знака прямолинейно (0 чтобы отключить)'; // cpg1.5 (???)
...
$lang_db_input_php['err_mkdir'] = 'Ошибка в создании директории %s!';

$lang_db_input_php['dest_dir_ro'] = 'Указанная директория %s не имеет прав на запись!';
...
$lang_db_input_php['com_added'] = 'Комментарий добавлен';
...
$lang_delete_php['caption'] = 'Описание';
...
$lang_delete_php['password_reset'] = 'Пароль сброшен для %s';

$lang_delete_php['change_group'] = 'Изменить основную группу';

$lang_delete_php['change_group_to_group'] = 'Изменение с %s на %s';

$lang_delete_php['add_group'] = 'Добавить вторичную группу';

$lang_delete_php['add_group_to_group'] = 'Добавляю пользователя %s в группу %s. Теперь он входит в основную группу %s и вторичную группу %s.';

$lang_delete_php['status'] = 'Статус';

$lang_delete_php['updating_album'] = 'Обновляю альбом '; // cpg1.5

$lang_delete_php['moved_picture_to_position'] = 'Перемещаю изображение %s на позицию %s'; // cpg1.5 (???)
...
$lang_display_comments['your_name'] = 'Гость';
...
$lang_report_php['invalid_email'] = '<b>Внимание</b>: неправильный email адрес!';
...
$lang_groupmgr_php['allowed'] = 'Разрешено';
...
$lang_install['create_table'] = 'Создание таблицы \'%s\'';
...
$lang_install['email_verif'] = 'Проверить email';
...
$lang_install['old_install'] = 'Это новый мастер установки. Нажмите %sтут%s для классического экрана усатновки.'; //cpg1.5
...
$lang_keywordmgr_php['confirm_delete'] = 'Вы уверены, что хотите удалить ключевое слово %s во всей галерее?'; // js-alert
...
$lang_langmgr_php['default_language'] = 'Выбран язык по умолчанию %s';
...
$lang_modifyalb_php['notice1'] = '(*) в зависимости от настроек %sгрупп%s';  //(do not translate %s!)

$lang_modifyalb_php['can_moderate'] = 'Альбом может модерироваться'; // cpg 1.5
...
$lang_sidebar_php['opera'] = 'Opera 6 и вышел'; // cpg1.5
...
$lang_upload_php['max_fsize'] = 'Максимально разрешенный размер %s';
...
$lang_usermgr_php['group_can_access'] = 'Альбомы, к которым имеют доступ только "%s"';
...
$lang_update_php['already_done'] = 'Почти готово'; // cpg1.5
...
$lang_util_php['older_than'] = 'Удаляю файлы старше %s дней';  // cpg1.5
